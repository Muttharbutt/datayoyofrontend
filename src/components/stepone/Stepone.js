 ...
 <>
      ...
      <div className="settingbackground">
        ...
        <div className="flexdiv">
          <div style={{  marginLeft: "12%"}} className="box1">
          <div  className=" flexdiv">
            
        <div className='textspan'>1.Importation des données comptables</div>  <div style={{marginTop:"-10px"}}><img style={{width:"60px"}} onClick={() => {setshow1(!show1)}}  src={question} alt=""/>  </div> 
             </div>
     {show1 && (
        <>
        ...
        {isLoading1 &&(<div style={{border:"1px solid  #FFB800",color:" #FFB800"}} className='greybox flexdiv'>
          ...
          <img style={{width:"20px",marginLeft:"64%"}} src={outline} alt='pic'/>
        </div>)}
        {isComplete1 && ( <div style={{border:"1px solid  #5DA83C",color:" #5DA83C"}} className='greybox flexdiv'>
          <div>Fichier importé avec succès</div>
          <img style={{width:"20px",marginLeft:"49%"}} src={ok} alt='pic'/>
          <img onClick={delete1} style={{width:"20px",marginLeft:"20px"}} src={trash} alt='pic'/>
        </div>)}
        <div className={isLoading1 || isComplete1 ? '' : 'hidden'}>
        <div className='flexdiv' style={{fontSize:"14px",marginTop:"20px",marginLeft:"3%"}}><div style={{marginRight:"15px"}}>{selectedFileNameN}</div> <div>{Math.round(fileSizeRef1.current/1048576)} MB</div></div>
      ...
      <div style={{marginTop:"10px",marginLeft:"3%",marginBottom:"17%"}} className="progress1-bar-container">
      ...
      {!isLoading && !isComplete && (
           <div style={{marginBottom:"70px"}} className='greybox'> Glisser ici le FEC ou le grand-livre de l’<b>année N</b> ou{' '}
      ...
      {isLoading &&(<div style={{border:"1px solid  #FFB800",color:" #FFB800"}} className='greybox flexdiv'>
        ...
        <div className='flexdiv' style={{fontSize:"14px",marginTop:"20px",marginLeft:"3%"}}><div style={{marginRight:"15px"}}>{selectedFileNameNMinus1}</div> <div>{Math.round(fileSizeRef.current/1048576)} MB</div></div>
            <div className={ !isComplete ? 'flexdiv' : 'hidden flexdiv'}> <div style={{marginRight:"100px",marginLeft:"50px"}}>{progress}%</div> <div>{uploadSpeed.toFixed(2)} KB-Sec</div></div>
      <div style={{marginTop:"10px",marginLeft:"3%",marginBottom:"5%"}} className="progress-bar-container">
          ...
          <div  className=" flexdiv">
            ...
            <div className='textspan'>2.Importation des reports à nouveaux </div>  <div style={{marginTop:"-10px"}}><img style={{width:"60px"}} onClick={() => {setshow2(!show2);console.log(show2)}}  src={question} alt=""/>  </div> 
                 </div>
                 {show2 && (
        <>
        <div style={{backgroundColor:"white",border:"1px solid lightgrey", borderRadius:"10px",padding:'2%',position:"absolute"}}>
  ...
  <li className='paddingboot'>Les reports à nouveaux sont obligatoires dans les extractions des FEC au sens de l’administration fiscale. Cependant, il est encore parfois difficile de les obtenir auprès des clients. C’est la raison pour laquelle il est possible d’intégrer les balances générales des exercices précédents : CAC BI réintégrera alors automatiquement les reports à nouveaux dans le GL N à partir de la BG N-1 ainsi que les reports à nouveaux dans le GL N-1 à partir de la BG N-2.</li>
    ...
    <div className='divinsidestepone'>
            <h4>La base N contient-elle les reports à nouveaux (le bilan d’ouverture) ?</h4>
      ...
      <h4 className='topmargin1'>La base N-1 contient-elle les reports à nouveaux (le bilan d’ouverture) ?</h4>
      <input style={{transform: "scale(1.3)"}} type='checkbox'/>
            <label > Oui</label><br/>
            <input style={{transform: "scale(1.3)"}} type='checkbox'/>
            <label style={{marginTop:'100px'}} > Non</label><br/>
      ...
      <input type="file" id='fileInput4' className="hidden" /></div>
        ...
        <button style={{marginTop:"7%",marginLeft:"41%",background:"white",border:"1px solid #1054FB",borderRadius:"20px",padding:"10px",paddingLeft:"40px",paddingRight:"40px",color:"#1054FB"}} onClick={handleCancel}>Annuler </button>
        <button style={{marginTop:"7%",marginLeft:"2%",background:"#1054FB",border:"1px solid #1054FB",borderRadius:"20px",padding:"10px",paddingLeft:"50px",paddingRight:"50px",color:"white"}} onClick={handleSaveAndNextClick}>Enregistrer et passer à l’étape suivante</button>
      </div>
 </>
)}
